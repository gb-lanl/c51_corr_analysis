...
data_directory = '/home/gbradley/c51_corr_analysis/tests/data/C13/' #all configurations
data_file = './data/C13/C13-b_4002.ama.h5' #single configuration

#fit_states = ['mres-L','mres-S', 'pion', 'kaon', 'proton', 'omega']
fit_states = ['proton', 'gA']
bs_seed = 'a09m310'
...
corr_lst = {
    ...
    # PROTON_A3
    'gA':{
        'dsets':['/3pt_tsep8/NUCL_D_MIXED_NONREL_l0_g0/src5.0_snk5.0/qz+0_qy+0_qx+2/C13.b_4002/AMA'],
                # '3pt_tsep10/NUCL_D_MIXED_NONREL_l0_g0/src5.0_snk5.0/qz+0_qy+0_qx+2/C13.b_4002/AMA'
                # '3pt_tsep12/NUCL_D_MIXED_NONREL_l0_g0/src5.0_snk5.0/qz+0_qy+0_qx+2/C13.b_4002/AMA',
                # '3pt_tsep14/NUCL_D_MIXED_NONREL_l0_g0/src5.0_snk5.0/qz+0_qy+0_qx+2/C13.b_4002/AMA'],
        'weights'  :[1],
        't_reverse':[False],
        'fold'     :False,
        'snks'     :['S', 'P'],
